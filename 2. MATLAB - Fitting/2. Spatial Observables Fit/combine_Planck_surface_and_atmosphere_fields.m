...
[dLW_PL_atm, lat, lon, years] = loadData([folder_path 'dLW_planck_atm_field.nc'], "__xarray_dataarray_variable__");
[dLW_PL_sur, ~, ~, ~] = loadData([folder_path 'dLW_ts_field.nc'], "__xarray_dataarray_variable__");

dLW_PL = dLW_PL_atm + dLW_PL_sur;

save_field([folder_path 'dLW_PL_field.nc'], dLW_PL, lon, lat, years)

%% Planck feedback (clear-sky)

[dLW_CS_PL_atm, ~, ~, ~] = loadData([folder_path 'dLW_CS_planck_atm_field.nc'], "__xarray_dataarray_variable__");
[dLW_CS_PL_sur, ~, ~, ~] = loadData([folder_path 'dLW_CS_ts_field.nc'], "__xarray_dataarray_variable__");

dLW_CS_PL = dLW_CS_PL_atm + dLW_CS_PL_sur;

save_field([folder_path 'dLW_CS_PL_field.nc'], dLW_CS_PL, lon, lat, years)
